var Terminal=function(b){this.m_parent=b;this.m_input=this.m_promptCommand=this.m_promptInfoWaitingForResponse=this.m_promptInfoWaitingForCommand=this.m_promptInfoPath=this.m_promptInfoSeparator=this.m_promptInfoUser=this.m_promptInfo=this.m_prompt=this.m_output=null;this.m_apiUrl=this.m_parent.dataset.action||location.href;this.m_isWaitingForResponse=!1;this.m_isWaitingForResponseIntervalHandle=null;this.m_isPasswordMode=!1;this.m_commandHistory=[];this.m_commandHistoryIndex=this.m_commandHistoryCount=
0;this.buildTerminalView();this.ehlo();this.m_input.focus()};
...
Terminal.prototype.inputKeyEvent=function(b){"Enter"===b.key?this.command():"ArrowUp"===b.key?this.commandHistoryPrevious():"ArrowDown"===b.key&&this.commandHistoryNext()};Terminal.prototype.commandHistoryPrevious=function(){this.m_isPasswordMode||0===this.m_commandHistoryCount||(this.m_commandHistoryIndex--,0>this.m_commandHistoryIndex&&(this.m_commandHistoryIndex=0),this.m_input.value=this.m_commandHistory[this.m_commandHistoryIndex])};
Terminal.prototype.commandHistoryNext=function(){this.m_isPasswordMode||0===this.m_commandHistoryCount||(this.m_commandHistoryIndex++,this.m_commandHistoryIndex>=this.m_commandHistoryCount?(this.m_commandHistoryIndex=this.m_commandHistoryCount,this.m_input.value=""):this.m_input.value=this.m_commandHistory[this.m_commandHistoryIndex])};Terminal.prototype.switchToCommandInterface=function(){this.m_isPasswordMode=!1;this.m_input.type="text";this.m_input.name="terminal[command]"};
Terminal.prototype.switchToPasswordInterface=function(){this.m_isPasswordMode=!0;this.m_input.type="password";this.m_input.name="terminal[password]"};
Terminal.prototype.startWaitingForResponse=function(){var b=this,c=["/","\u2014","\\","|"],e=0,a=c.length;this.m_promptInfoWaitingForResponse.textContent=c[e];this.m_isWaitingForResponse=!0;this.m_isWaitingForResponseIntervalHandle=setInterval(function(){e++;e>a-1&&(e=0);b.m_promptInfoWaitingForResponse.textContent=c[e]},150);this.m_promptInfoWaitingForCommand.style.display="none";this.m_promptInfoWaitingForResponse.style.display="inline";this.m_input.disabled=!0};
...
Terminal.prototype.ehlo=function(){var b=this,c=new FormData;c.append("request","ehlo");var e=function(){b.stopWaitingForResponse()};this.startWaitingForResponse();SimpleRequest.post(this.m_apiUrl,c,function(a){null!==a&&"ERROR"!==a.status&&"undefined"!==typeof a.response&&null!==a.response&&(b.m_input.style.visibility="visible","ready"===a.response?(b.setPromptInfo(a.user,a.path),b.switchToCommandInterface()):b.switchToPasswordInterface(),"undefined"!==typeof a.output&&null!==a.output&&b.printOutput(a.output));
b.stopWaitingForResponse()},e,e,null,{get_json:!0})};
Terminal.prototype.logIn=function(){var b=this,c=new FormData;c.append("request","log-in");c.append("password",this.m_input.value);var e=function(a){a=void 0===a?null:a;null!==a&&"undefined"!==typeof a.output&&null!==a.output?b.printOutput(a.output):("string"===typeof a||a instanceof String)&&b.printOutput(a);b.stopWaitingForResponse()};this.startWaitingForResponse();SimpleRequest.post(this.m_apiUrl,c,function(a){null===a||"ERROR"===a.status?e(a):"undefined"===typeof a.response||null===a.response?
e(a):"ready"===a.response?(b.clearOutput(),b.setPromptInfo(a.user,a.path),b.switchToCommandInterface(),"undefined"!==typeof a.output&&null!==a.output&&b.printOutput(a.output),b.stopWaitingForResponse()):e(a)},e,e,null,{get_json:!0})};
Terminal.prototype.command=function(){var b=this;if(!this.m_isWaitingForResponse)if(this.m_isPasswordMode)this.logIn();else{var c=this.m_input.value.trim().toLowerCase();this.m_commandHistory.push(c);this.m_commandHistoryIndex=this.m_commandHistoryCount=this.m_commandHistory.length;if("clear"===c)this.clearOutput(),this.stopWaitingForResponse();else{this.startWaitingForResponse();var e=new FormData;e.append("request","command");e.append("command",c);var a=function(a){a=void 0===a?null:a;null!==a&&
...
d.response&&(b.clearPromptInfo(),b.switchToPasswordInterface()),b.stopWaitingForResponse())},a,a,null,{get_json:!0})}}};
