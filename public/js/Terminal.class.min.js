...
this.m_editorSaveWaitingForResponse.textContent="";this.m_editorSave.appendChild(this.m_editorSaveWaitingForResponse);this.m_editorSave.appendChild(document.createTextNode("]"));this.m_history=document.createElement("div");this.m_history.classList.add("terminal__history");c.appendChild(this.m_history);this.m_historyPrevious=document.createElement("a");this.m_historyPrevious.classList.add("previous");this.m_historyPrevious.textContent="[\u2b06]";this.m_history.appendChild(this.m_historyPrevious);this.m_historyNext=
document.createElement("a");this.m_historyNext.classList.add("next");this.m_historyNext.textContent="[\u2b07]";this.m_history.appendChild(this.m_historyNext);this.m_parent.appendChild(c)};
