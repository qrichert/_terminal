var Terminal=function(a){this.m_parent=a;this.m_historyNext=this.m_historyPrevious=this.m_history=this.m_editorSaveWaitingForResponse=this.m_editorSave=this.m_editorCancel=this.m_editorFilename=this.m_editorInterface=this.m_editorTextArea=this.m_editor=this.m_input=this.m_password=this.m_promptCommand=this.m_promptInfoWaitingForResponse=this.m_promptInfoWaitingForCommand=this.m_promptInfoPath=this.m_promptInfoSeparator=this.m_promptInfoUser=this.m_promptInfo=this.m_prompt=this.m_output=null;this.m_apiUrl=
this.m_parent.dataset.action||location.href;this.m_isWaitingForResponse=!1;this.m_isWaitingForResponseIntervalHandle=null;this.Mode={COMMAND:"command",EDITOR:"editor",PASSWORD:"password"};this.m_mode=this.Mode.COMMAND;this.m_editorCurrentFileData=null;this.m_commandHistory=[];this.m_commandHistoryIndex=this.m_commandHistoryCount=0;this.buildTerminalView();this.addListeners();this.ehlo()};
...
this.m_promptCommand=document.createElement("div");this.m_promptCommand.classList.add("terminal__prompt--command");this.m_prompt.appendChild(this.m_promptCommand);this.m_password=document.createElement("input");this.m_password.type="password";this.m_password.name="terminal[password]";this.m_password.style.display="none";this.m_password.addEventListener("keydown",function(c){a.inputKeyEvent(c)},!1);this.m_promptCommand.appendChild(this.m_password);this.m_input=document.createElement("input");this.m_input.type=
"text";this.m_input.name="terminal[command]";this.m_input.autocapitalize="none";this.m_input.autocomplete=!1;this.m_input.autocorrect=!1;this.m_input.spellcheck=!1;this.m_input.style.display="none";this.m_input.addEventListener("keydown",function(c){a.inputKeyEvent(c)},!1);this.m_promptCommand.appendChild(this.m_input);this.m_editor=document.createElement("div");this.m_editor.classList.add("terminal__editor");c.appendChild(this.m_editor);this.m_editorTextArea=document.createElement("textarea");this.m_editorTextArea.classList.add("terminal__editor--textarea");
this.m_editor.appendChild(this.m_editorTextArea);this.m_editorInterface=document.createElement("div");this.m_editorInterface.classList.add("terminal__editor--interface");this.m_editor.appendChild(this.m_editorInterface);this.m_editorFilename=document.createElement("p");this.m_editorFilename.classList.add("filename");this.m_editorFilename.textContent="";this.m_editorInterface.appendChild(this.m_editorFilename);this.m_editorCancel=document.createElement("a");this.m_editorCancel.classList.add("cancel");
this.m_editorCancel.textContent="[Cancel]";this.m_editorInterface.appendChild(this.m_editorCancel);this.m_editorSave=document.createElement("a");this.m_editorSave.classList.add("save");this.m_editorInterface.appendChild(this.m_editorSave);this.m_editorSave.appendChild(document.createTextNode("[Save"));this.m_editorSaveWaitingForResponse=document.createElement("span");this.m_editorSaveWaitingForResponse.textContent="";this.m_editorSave.appendChild(this.m_editorSaveWaitingForResponse);this.m_editorSave.appendChild(document.createTextNode("]"));
this.m_history=document.createElement("div");this.m_history.classList.add("terminal__history");this.m_history.classList.add("hidden");c.appendChild(this.m_history);this.m_historyPrevious=document.createElement("a");this.m_historyPrevious.classList.add("previous");this.m_historyPrevious.textContent="[\u2b06]";this.m_history.appendChild(this.m_historyPrevious);this.m_historyNext=document.createElement("a");this.m_historyNext.classList.add("next");this.m_historyNext.textContent="[\u2b07]";this.m_history.appendChild(this.m_historyNext);
...
Terminal.prototype.switchToCommandInterface=function(){this.m_mode=this.Mode.COMMAND;this.m_password.style.display="none";this.m_input.style.display=null;this.m_editor.classList.remove("shown");this.m_history.classList.remove("hidden");this.m_input.focus()};Terminal.prototype.switchToEditorInterface=function(){this.m_mode=this.Mode.EDITOR;this.m_editor.classList.add("shown");this.m_history.classList.add("hidden");this.m_editorTextArea.focus()};
Terminal.prototype.switchToPasswordInterface=function(){this.m_mode=this.Mode.PASSWORD;this.m_password.style.display=null;this.m_input.style.display="none";this.m_editor.classList.remove("shown");this.m_history.classList.add("hidden");this.m_password.focus()};
...
"inline";this.m_password.disabled=!0;this.m_input.disabled=!0;this.m_editorTextArea.disabled=!0;this.m_editorCancel.style.visibility="hidden"};
Terminal.prototype.stopWaitingForResponse=function(){this.m_promptInfoWaitingForCommand.style.display="inline";this.m_promptInfoWaitingForResponse.style.display="none";this.m_password.disabled=!1;this.m_password.value="";this.m_input.disabled=!1;this.m_input.value="";this.m_editorSaveWaitingForResponse.textContent="";this.m_editorTextArea.disabled=!1;this.m_editorCancel.style.visibility=null;this.m_isWaitingForResponse=!1;clearInterval(this.m_isWaitingForResponseIntervalHandle)};
...
Terminal.prototype.ehlo=function(){var a=this,c=new FormData;c.append("request","ehlo");var e=function(){a.stopWaitingForResponse()};this.startWaitingForResponse();SimpleRequest.post(this.m_apiUrl,c,function(b){null!==b&&"ERROR"!==b.status&&"undefined"!==typeof b.response&&null!==b.response&&("ready"===b.response?(a.setPromptInfo(b.user,b.path),a.switchToCommandInterface()):a.switchToPasswordInterface(),"undefined"!==typeof b.output&&null!==b.output&&a.printOutput(b.output));a.stopWaitingForResponse()},
e,e,null,{get_json:!0})};
Terminal.prototype.logIn=function(){var a=this,c=new FormData;c.append("request","log-in");c.append("password",this.m_password.value);var e=function(b){b=void 0===b?null:b;null!==b&&"undefined"!==typeof b.output&&null!==b.output?a.printOutput(b.output):("string"===typeof b||b instanceof String)&&a.printOutput(b);a.stopWaitingForResponse()};this.startWaitingForResponse();SimpleRequest.post(this.m_apiUrl,c,function(b){null===b||"ERROR"===b.status?e(b):"undefined"===typeof b.response||null===b.response?
e(b):"ready"===b.response?(a.clearOutput(),a.setPromptInfo(b.user,b.path),a.switchToCommandInterface(),"undefined"!==typeof b.output&&null!==b.output&&a.printOutput(b.output),a.stopWaitingForResponse()):e(b)},e,e,null,{get_json:!0})};
