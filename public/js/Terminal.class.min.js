...
null;this.Mode={COMMAND:"command",EDITOR:"editor",PASSWORD:"password"};this.m_mode=this.Mode.COMMAND;this.m_commandHistory=[];this.m_commandHistoryIndex=this.m_commandHistoryCount=0;this.buildTerminalView();this.addListeners();this.ehlo();this.m_input.focus()};
...
Terminal.prototype.addListeners=function(){var b=this;window.addEventListener("load",function(){b.restoreCommandHistory()},!1);window.addEventListener("unload",function(){b.saveCommandHistory()},!1)};Terminal.prototype.inputKeyEvent=function(b){"Enter"===b.key?this.command():"ArrowUp"===b.key?this.commandHistoryPrevious():"ArrowDown"===b.key&&this.commandHistoryNext()};
Terminal.prototype.saveCommandHistory=function(){localStorage.setItem("_terminal__command-history",JSON.stringify(this.m_commandHistory));return"save"};Terminal.prototype.restoreCommandHistory=function(){this.m_commandHistory=[];try{var b=JSON.parse(localStorage.getItem("_terminal__command-history"));Array.isArray(b)&&(this.m_commandHistory=b)}catch(c){}this.m_commandHistoryIndex=this.m_commandHistoryCount=this.m_commandHistory.length};
Terminal.prototype.commandHistoryAppend=function(b){b!==this.m_commandHistory[this.m_commandHistoryCount-1]&&(this.m_commandHistory.push(b),this.m_commandHistoryCount=this.m_commandHistory.length,100<this.m_commandHistoryCount&&(b=this.m_commandHistoryCount-100,this.m_commandHistoryCount=100,this.m_commandHistory.splice(0,b)));this.m_commandHistoryIndex=this.m_commandHistoryCount};
