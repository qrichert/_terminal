...
null;this.m_isPasswordMode=!1;this.m_commandHistory=[];this.m_commandHistoryIndex=this.m_commandHistoryCount=0;this.Mode={COMMAND:"command",EDIT:"edit"};this.m_mode=this.Mode.COMMAND;this.buildTerminalView();this.ehlo();this.m_input.focus()};
