...
"";this.m_editorInterface.appendChild(this.m_editorFilename);this.m_editorCancel=document.createElement("a");this.m_editorCancel.classList.add("cancel");this.m_editorCancel.textContent="[Cancel]";this.m_editorInterface.appendChild(this.m_editorCancel);this.m_editorSave=document.createElement("a");this.m_editorSave.classList.add("save");this.m_editorSave.textContent="[Save]";this.m_editorInterface.appendChild(this.m_editorSave);this.m_parent.appendChild(c)};
Terminal.prototype.addListeners=function(){var a=this;window.addEventListener("load",function(){a.restoreCommandHistory()},!1);window.addEventListener("unload",function(){a.saveCommandHistory()},!1);this.m_editorCancel.addEventListener("click",function(c){c.preventDefault();a.editorCancel()},!1);this.m_editorSave.addEventListener("click",function(c){c.preventDefault();a.editorSave()},!1)};
Terminal.prototype.inputKeyEvent=function(a){"Enter"===a.key?this.command():"ArrowUp"===a.key?this.commandHistoryPrevious():"ArrowDown"===a.key&&this.commandHistoryNext()};Terminal.prototype.saveCommandHistory=function(){localStorage.setItem("_terminal--command-history",JSON.stringify(this.m_commandHistory))};
...
Terminal.prototype.commandHistoryAppend=function(a){a!==this.m_commandHistory[this.m_commandHistoryCount-1]&&(this.m_commandHistory.push(a),this.m_commandHistoryCount=this.m_commandHistory.length,100<this.m_commandHistoryCount&&(a=this.m_commandHistoryCount-100,this.m_commandHistoryCount=100,this.m_commandHistory.splice(0,a)));this.m_commandHistoryIndex=this.m_commandHistoryCount};
...
Terminal.prototype.switchToCommandInterface=function(){this.m_mode=this.Mode.COMMAND;this.m_input.type="text";this.m_input.name="terminal[command]";this.m_editor.classList.remove("shown");this.m_input.focus()};Terminal.prototype.switchToEditorInterface=function(){this.m_mode=this.Mode.EDITOR;this.m_editor.classList.add("shown");this.m_editorTextArea.focus()};
Terminal.prototype.switchToPasswordInterface=function(){this.m_mode=this.Mode.PASSWORD;this.m_input.type="password";this.m_input.name="terminal[password]";this.m_editor.classList.remove("shown");this.m_input.focus()};
...
{file:"",filename:"",new_file:!1,content:""},"undefined"!==typeof d.file&&null!==d.file&&(a.m_editorCurrentFileData.file=d.file),"undefined"!==typeof d.filename&&null!==d.filename&&(a.m_editorCurrentFileData.filename=d.filename),"boolean"===typeof d.new_file&&(a.m_editorCurrentFileData.new_file=d.new_file),"undefined"!==typeof d.content&&null!==d.content&&(a.m_editorCurrentFileData.content=d.content),console.log(a.m_editorCurrentFileData),a.m_editorTextArea.value=a.m_editorCurrentFileData.content,
a.m_editorFilename.textContent='"'+a.m_editorCurrentFileData.filename+'"'+(a.m_editorCurrentFileData.new_file?" [New File]":""),a.switchToEditorInterface()),a.stopWaitingForResponse(),a.m_input.focus())},b,b,null,{get_json:!0})}}};Terminal.prototype.editorCancel=function(){this.switchToCommandInterface();this.m_editorCurrentFileData=null};
...
b.response?e(b):a.stopWaitingForResponse()},e,e,null,{get_json:!0});this.switchToCommandInterface();this.m_editorCurrentFileData=null;this.m_editorTextArea.value=""}};
